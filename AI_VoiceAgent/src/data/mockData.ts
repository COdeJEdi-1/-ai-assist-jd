...
export const candidateResults: CandidateResult[] = [
  {
    ...
    currentJobRolesResponsibility: 'Backend development and API design',
    jobChange: 'Yes',
    jobChangeReason: 'Better growth opportunity',
    familyBackground: '—',
    noticePeriod: '60 days',
    currentLocation: 'Bangalore, Karnataka',
    willingToRelocate: 'No',
    preferredLocations: 'NA',
    joiningTime: '2 months',
    joiningStatus: 'After notice period',
    result: 'Qualified',
    status: 'completed',
  },
  {
    ...
    currentJobRolesResponsibility: 'Recruitment and employee onboarding',
    jobChange: 'Yes',
    jobChangeReason: 'Relocation to Pune',
    familyBackground: '—',
    noticePeriod: '30 days',
    currentLocation: 'Mumbai, Maharashtra',
    willingToRelocate: 'Depends',
    preferredLocations: 'Pune, Bangalore',
    joiningTime: '1 month',
    joiningStatus: 'Immediate after notice',
    result: 'Qualified',
    status: 'completed',
  },
  {
    ...
    currentCtc: '₹18 LPA',
    expectedCtc: '₹22 LPA',
    currentJob: 'Production Manager',
    currentJobRolesResponsibility: 'Shop floor operations and team management',
    jobChange: 'No',
    jobChangeReason: '—',
    familyBackground: '—',
